...
if (launch_minimization)
	...
	save_wt_to_file(wt, 'output/task4_2dampers_0_2_wt.txt');
endif
...
if (show_or_print_grid_and_wt)
	...
	wt = read_wt_from_file('output/task4_2dampers_0_2_wt.txt');
...
print(sprintf('tasks/task%d_%ddampers_t_%f_cut.eps', task, num_of_dampers, t), '-color', '-S480, 320');