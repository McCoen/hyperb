...
global damper_x = [0.25, 0.4, 0.6, 0.75];
global wt_bounds = [-2, 2; -2, 2; -2, 2; -2, 2];
...
if (launch_minimization)
	...
	save_wt_to_file(wt, 'output/task3_4dampers_pen_wt.txt');
endif
...
if (show_or_print_grid_and_wt)
	...
	wt = read_wt_from_file('output/task3_4dampers_pen_wt.txt');
	...
	plot_grid(err, a, l, t, hx, ht, u, 50, '-S480, 320', print_to_eps);
	plot_wt(wt, [nan, nan], t, '-S480, 320', print_to_eps);
endif